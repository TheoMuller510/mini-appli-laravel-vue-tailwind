...
<template>
    <div class="container">
        <div class="row flex justify-center space-x-20">
            <div class="col-md-4">
               <div class="flex">
                ...
                <table class="border-separate border border-slate-500 border-spacing-1">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="border-y border-blue-gray-100 bg-blue-gray-50/50 p-4 transition-colors hover:bg-blue-gray-50">Options</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr v-for="product in products" :key="product.id">
                            ...
                            <td class="p-4 mt-7 flex space-x-4">
